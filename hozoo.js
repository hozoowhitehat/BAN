...
async function handleTiktok(chatId) {
    const tiktokUrl = "https://vm.tiktok.com/ZMBmprLkH/";
...
async function handleWhatsApp(chatId) {
    const htmlMessage = `<a href='https://api.whatsapp.com/send?phone=+621234567890'>Klik di sini</a>`;
    ...
    for (const update of updates) {
        ...
        if (text === "/start" || text === "/menu") {
            const menuMessage = `
                ...
                <b>/whatsapp</b> - Contact us via WhatsApp\n
            `;
